    ...
    if (isDesktop) {
      ...
      loginWithGoogle(code, redirectUri)
        .then(async (loggedInUser) => {
          ...
          //    login on app.cyberagent.sh instead of clicking the email link,
      ...
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Opening CyberAgent</CardTitle>
            <CardDescription>
              You should see a prompt to open the CyberAgent desktop app. If
