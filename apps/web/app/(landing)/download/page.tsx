...
export const metadata: Metadata = {
  title: "Download CyberAgent",
  description:
    "Download CyberAgent for macOS, Windows, or Linux — or install the CLI for servers and remote dev boxes.",
  openGraph: {
    title: "Download CyberAgent",
    description:
      "Get the CyberAgent desktop app with a bundled daemon, or install the CLI for servers and remote dev boxes.",
    url: "/download",
  },
  alternates: {
    canonical: "/download",
