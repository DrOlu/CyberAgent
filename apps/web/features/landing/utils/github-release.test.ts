...
const SAMPLE_LATEST_ASSET = {
  ...
  browser_download_url:
    "https://github.com/DrOlu/CyberAgent/releases/download/v0.2.14/multica-desktop-0.2.14-mac-arm64.dmg",
};

const SAMPLE_PREV_ASSET = {
  name: "multica-desktop-0.2.13-mac-arm64.dmg",
  browser_download_url:
    "https://github.com/DrOlu/CyberAgent/releases/download/v0.2.13/multica-desktop-0.2.13-mac-arm64.dmg",
};
...
function releasePayload(overrides: {
  ...
  return {
    ...
    html_url: `https://github.com/DrOlu/CyberAgent/releases/tag/${overrides.tag}`,
