...
/**
 * Server-side fetcher for the latest CyberAgent release, designed to
...
const GITHUB_RELEASES_URL =
  "https://api.github.com/repos/cyberagent.sh/multica/releases?per_page=2";
...
export async function fetchLatestRelease(): Promise<LatestRelease> {
  ...
  try {
    ...
    // Defensive filter — CyberAgent doesn't publish prereleases or drafts
