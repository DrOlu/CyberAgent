...
export function createJaDict(
  ...
  return {
    ...
    hero: {
      ...
      subheading:
        "Multica は、コーディングエージェントを本物のチームメンバーに変える、ソースコード公開型のプラットフォームです。タスクを割り当て、進捗を追い、ノウハウをスキルとして積み上げる。人間と AI エージェントから成るチームを、ひとつの場所で管理できます。",
      cta: "無料トライアルを始める",
      ...
      highlights: [
        {
          title: "どこでもセルフホスト",
          description:
            "自社のインフラで Multica を運用できます。Docker Compose、単一バイナリ、Kubernetes に対応。ワークスペースのデータは、自分で管理するサーバーに保存されます。",
        },
        {
          title: "ベンダーロックインなし",
          description:
      ...
      items: [
        {
          ...
          answer:
            "Multica は、Antigravity、Claude Code、CodeBuddy、CodeArts、Codex、Copilot、Cursor、DeepSeek Harness、DevEco Code、Dim、Grok、Hermes、Kimi、Kiro CLI、MiniMax Code、Oh-My-Pi、OpenClaw、OpenCode、Pi、Qoder、Qoder CN、Qwen Code、QwenPaw、Reasonix、Trae CLI、ZeroClaw の26種類のコーディングツールに標準対応しています。デーモンが、すでにインストール済みの CLI を自動検出し、それぞれをランタイムとして登録します。ソースコードが公開されているので、独自のバックエンドを追加することもできます。",
        },
        {
        ...
        },
        {
          ...
          answer:
            "はい。自社の組織内で Multica を使うのは無料です。チーム全体のためにセルフホストする場合も同様です。商用ライセンスが必要になるのは、ホスティングサービスやマネージドサービスなどとして組織外の人に Multica を提供する場合と、販売・配布する製品に Multica を組み込む場合です。よくあるケースは[ライセンスについて](/licensing)で説明しています。",
        },
        {
          question:
        ...
        },
        {
          ...
          answer:
            "エージェントは、あなたのマシン(ローカルデーモン経由)や接続したランタイム上で動作し、コードリポジトリの中で直接作業します。ワークスペースに入力した内容(タスク、コメント、チャットメッセージ、添付ファイル、エージェントが報告する進捗)は Multica に保存されます。また、エージェントが使うコーディングツールは、プロンプトとコードを設定したモデルプロバイダーに送信します。ワークスペースのデータを自社のサーバーに置きたい場合は、Multica をセルフホストしてください。詳しくは[プライバシーポリシー](/privacy)をご覧ください。",
        },
        {
          question: "エージェントは何個まで動かせますか?",
          answer:
            "ハードウェアが許す限り、いくつでも動かせます。エージェントごとに同時実行数を設定でき、複数のマシンをランタイムとして接続することもできます。セルフホストする場合、人為的な上限はありません。",
        },
      ],
    },
    footer: {
      ...
      entries: [
        {
          version: "0.5.3",
          date: "2026-09-24",
          title: "Telegram のメディア送受信、モバイルの簡体字中国語、Issue とプルリクエストの自動完了、より正確な使用量",
          changes: [],
          features: [
            "Telegram で写真・動画・音声・ファイルをエージェントに渡せます。",
            "エージェントが作った添付ファイルも Telegram に返ってきます。",
            "モバイルアプリの言語を、簡体字中国語・英語・端末の設定から選べます。",
            "Issue に紐づくプルリクエストが見え、すべてマージされると自動で完了します。",
            "Antigravity でエージェントのツール実行の様子を、その場で見られます。",
            "Grok Build のタスクに、実行中でも新しい指示を足せます。",
            "Issue の添付ファイルを全画面で次々に見ていけます。",
            "ドキュメントサイトをすべてフランス語で読めます。",
            "サイトでライセンスの説明、プライバシーポリシー、チームの紹介が見られます。",
            "セルフホストの管理者は、自動タイトルとクイック アクションの応答を速くできます。",
          ],
          improvements: [
            "コメントの操作が目的ごとにまとまり、編集と解決が先に並びます。",
          ],
          fixes: [
            "再開した Claude のセッションは、今回の実行分だけを使用量に数えます。",
            "Issue とランタイムのキャッシュヒット率が、実際より高く出なくなります。",
            "スレッドのエージェントの返信が、送られた順に並びます。",
            "Windows のタスクは、ファイルが一時的に使われていても起動します。",
            "DingTalk の Issue リンクに余分な文字が出なくなります。",
            "セルフホストは信頼されない証明書の理由を説明し、自分の CA も信頼できます。",
          ],
        },
        {
          version: "0.5.2",
    ...
    about: {
      ...
      paragraphs: [
        ...
        "ソースコードは公開されており、無料でセルフホストできます。ワークスペースのデータは、あなた自身のインフラに保存されます。すべてのコードを確認し、API を拡張し、好きな LLM プロバイダーを持ち込み、コミュニティに貢献できます。",
      ],
      cta: "GitHub で見る",
      team: {
        title: "Multica をつくっているチーム",
        paragraphs: [
          "Multica は、2021年から一緒に働いてきた小さなチームがつくっています。Multica の前は、開発者向けの AI 検索エンジン devv.ai を開発していました。2025年、私たち自身が何度もぶつかってきた課題、つまり小さなチームが AI エージェントと一緒に実際に仕事を進めるにはどうすればいいのか、に取り組み始めました。それが Multica です。",
          "ソースコードは公開されていてセルフホストもできるので、Multica の上に何かを築く前に、すべてのコードを確認できます。セルフホストした環境は、すべてあなた自身のインフラ上で動きます。商用利用のルールは[ライセンスについて](/licensing)のページで説明しています。",
        ],
        contacts: [
    ...
    licensing: {
      title: "ライセンス",
      intro: [
        "Multica は [Multica License](https://github.com/multica-ai/multica/blob/main/LICENSE) のもとで公開されています。Apache License 2.0 に、いくつかの追加条件を加えたライセンスです。ソースコードは公開されており、自社の組織内で Multica を使うのは無料です。チーム全体のためにセルフホストする場合も同様です。",
        "主な追加条件は、ホスティングでの利用に関するものです。組織外の人に Multica を提供するには、商用ライセンスが必要です。このページでは、よくいただく質問をもとに、その線引きを説明します。これはわかりやすさを優先した案内であり、法的助言ではありません。LICENSE 本文と内容が異なる場合は、LICENSE が優先されます。",
      ],
      rule: {
        title: "判断の目安",
        text: "組織外の誰かが、このインスタンスを動かしているかどうか。つまり、タスクを作成したり、エージェントと対話したり、作業をトリガーしたりしているかどうかです。そうであれば、Web、Slack、API のどの経路でも、ホスティングサービスにあたります。あなたのチームが Multica でつくった成果物を受け取るだけなら、社内利用です。",
      },
      scenarios: {
        title: "よくあるケース",
        scenarioColumn: "ケース",
        licenseColumn: "商用ライセンス",
        required: "必要",
        notRequired: "不要",
        items: [
          {
            scenario: "自社の組織内で Multica を使う",
            example: "セルフホストで、ワークスペースの数は問いません。",
            required: false,
          },
          {
            scenario: "クライアントのために Multica を導入し、クライアント自身が所有して社内で使う",
            example: "導入支援、トレーニング、コンサルティング、カスタマイズなど。",
            required: false,
          },
          {
            scenario: "自社チームが Multica を使ってクライアントの仕事をし、クライアントは成果物だけを受け取る",
            example: "たとえば、Multica でコンテンツ制作を管理し、完成品を納品するエージェンシー。",
            required: false,
          },
          {
            scenario: "エージェントがクライアントの Slack チャンネルにレポートや通知を一方向に送るだけ",
            example: "クライアントは内容を読むだけで、インスタンスとはやり取りしません。",
            required: false,
          },
          {
            scenario: "自社のインフラ上で、クライアントのために Multica インスタンスを運用・管理する",
            example: "マネージドサービス。料金を取るかどうかは関係ありません。",
            required: true,
          },
          {
            scenario: "組織外の人があなたのインスタンスにログインする",
            example: "クライアント、パートナー、一般ユーザーが自分のアカウントを持つ場合。",
            required: true,
          },
          {
            scenario: "組織外の人が別の入口からあなたのインスタンスを動かす",
            example: "Multica をバックエンドにした公開サイト、Slack 連携、API など。無料で提供する場合も同様です。",
            required: true,
          },
          {
            scenario: "販売・配布する製品に Multica を組み込む",
            example: "Multica が別の商用製品のコンポーネントとして提供される場合。",
            required: true,
          },
        ],
      },
      sections: [
        {
          ...
          bullets: [
            ...
            "帰属表示: Multica のインターフェースを使わずに、バックエンド、デーモン、CLI の上に製品を構築する場合は、著作権表示と NOTICE の内容を残し、ユーザー向けドキュメントに Multica をベースにしていることを [GitHub リポジトリ](https://github.com/multica-ai/multica)へのリンクとともに明記してください。",
            "フォーク: フォークのソースコードを公開すること自体はホスティングサービスではなく、商用ライセンスは不要です。ただし、そのフォークでホスティングサービスを運営する人は、それぞれ商用ライセンスが必要です。",
            "商用ライセンスとブランド表示の免除は別々の許諾です。一方を得ても、もう一方は含まれません。",
          ],
        },
        {
          heading: "商用ライセンスの取得",
    ...
    privacy: {
      title: "プライバシーポリシー",
      lastUpdated: "最終更新日: 2026年9月24日",
      intro: [
        "このプライバシーポリシーは、Index Labs (Hong Kong) Limited(以下「Multica」または「当社」)が、multica.ai へのアクセス、当社へのお問い合わせ、またはホスティングサービスである CyberAgent Cloud(Web、デスクトップ、モバイルアプリを含む)のご利用に際して、個人情報をどのように収集、利用、共有するかを説明するものです。",
        "このポリシーは、お客様がご自身でホストする Multica には適用されません。セルフホスト環境のデータは運用者が管理し、どの AI プロバイダー、連携サービス、分析ツールを使うかは運用者の設定によります。セルフホストのサーバーが当社に送信するのは、1日1回の利用状況スナップショットのみです。内容は、同じサーバーのスナップショットを関連付けるためのランダムな環境 ID、サーバーのバージョン、ワークスペース・メンバー・エージェント・接続中のデーモンのおおよその数、その日に開始・完了・失敗・キャンセルされた実行の数です。氏名、メールアドレス、コンテンツは含まれません。DO_NOT_TRACK=1 を設定すると、このスナップショットの送信を停止できます。",
        "このポリシーは英語版を正本とします。日本語版と英語版の内容が異なる場合は、英語版が優先されます。",
      ],
      sections: [
        {
          heading: "収集する情報",
          bullets: [
            "アカウント情報: 氏名、メールアドレス、プロフィール画像。Google でサインインした場合は、Google から氏名、メールアドレス、プロフィール画像を受け取ります。言語、タイムゾーン、自己紹介などのプロフィール情報や、オンボーディングでの回答(役割、用途、Multica を知ったきっかけなど)を入力いただくこともできます。",
            "お客様が作成するコンテンツ: ワークスペース、タスク、コメント、チャットメッセージ、添付ファイル、エージェントへの指示など、お客様またはお客様のエージェントが CyberAgent Cloud に入力するすべてのもの。",
            "営業へのお問い合わせ: 氏名、業務用メールアドレス、会社名と規模、国・地域、用途、目標、ご連絡に関するご希望。不正利用を防ぐため、フォーム送信時の IP アドレスとブラウザのユーザーエージェントも記録します。",
            "請求情報: サブスクリプションの支払いは、Stripe がホストするページで Stripe が処理します。当社がカード情報の全体を受け取ったり保存したりすることはありません。",
            "利用状況とデバイスの情報: アプリのバージョン、OS、クライアントの種類、ランダムに生成されたインストール ID。ランタイムとして接続した各マシンの名前(デフォルトはホスト名)。クラッシュやエラーのレポート。レポートの送信前に、エラーメッセージから識別できるメールアドレスや認証情報を取り除きますが、レポートには不具合の状況に関するその他の情報が含まれることがあります。",
            "フィードバック: フィードバックをお送りいただいた場合、その内容と、ページ、アプリのバージョン、OS、エラーの詳細。",
          ],
        },
        {
          heading: "情報の利用目的",
          bullets: [
            "CyberAgent Cloud の提供、運用、保護(サインイン、ワークスペースの同期、通知や招待の配信など)。",
            "営業へのお問い合わせやサポートへの対応。",
            "サインインコードやワークスペースへの招待など、サービスに関するメッセージの送信。製品のお知らせやマーケティング情報は同意いただいた場合にのみお送りし、いつでも配信を停止できます。",
            "Multica の利用状況の把握、不具合の修正、製品の改善。",
            "不正利用の防止と法的義務の履行。",
          ],
        },
        {
          heading: "法的根拠",
          paragraphs: [
            "法令で処理の法的根拠の明示が求められる地域では、次の根拠に基づいて個人情報を処理します。CyberAgent Cloud を提供するためのお客様との契約の履行、Multica の安全確保・サポート・改善およびお問い合わせへの対応に関する当社の正当な利益、マーケティング情報の受信に関するお客様の同意、そして当社の法的義務の遵守です。",
          ],
        },
        {
          heading: "AI 機能",
          paragraphs: [
            "コーディングエージェントは、お客様自身のマシンやお客様が接続したランタイム上で、お客様が設定したコーディングツールとアカウントを使って動作します。エージェントがローカルで動いていても、モデルの推論までローカルで行われるわけではありません。これらのツールは、プロンプト、コード、ファイル、ツールの実行結果をそれぞれのモデルプロバイダーに送信し、その扱いはお客様が使うツールとアカウントの規約に従います。Multica はエージェントの作業を調整します。",
            "CyberAgent Cloud の一部の機能(チャットのタイトル生成や、次のアクションの提案など)では、結果を生成するために、最初のチャットメッセージや直近のいくつかのメッセージを、当社が選んだ外部の大規模言語モデルプロバイダーに送信します。Multica がお客様のコンテンツを AI モデルの学習に使うことはありません。",
          ],
        },
        {
          heading: "Cookie と分析",
          paragraphs: [
            "サインイン状態の維持、クロスサイトリクエストフォージェリの防止、アップロードしたファイルへのアクセスのために、必要な Cookie を使用します。また、どのキャンペーンやサイトから来訪されたかを最長30日間記録する Cookie や、言語と最後に開いたワークスペースを記憶する Cookie も使用します。",
            "製品の利用状況の把握とクラッシュレポートの収集には PostHog を使用します。サインイン中は、レポートをアカウントとひも付けるため、アカウントの氏名とメールアドレスが PostHog に送信されます。広告目的の Cookie は使用せず、お客様の個人情報を販売することもありません。",
          ],
        },
        {
          heading: "情報の共有先",
          paragraphs: [
            "ワークスペースに入力した情報は、ワークスペースの権限設定に従って、他のメンバーや管理者、そして彼らが許可したエージェントや連携サービスから閲覧できます。ワークスペースが組織に属している場合、その内容は組織が管理し、関連するご依頼にも組織が対応することがあります。",
            "法令で求められる場合には情報を開示します。また、Multica が合併、買収、事業譲渡の対象となった場合、情報が買収者または承継者に移転されることがあります。",
            "それ以外に当社が個人情報を共有するのは、Multica の運営を支援するサービス提供者と、お客様が接続を選んだ連携サービスに限られます。",
          ],
          bullets: [
            "Amazon Web Services: ホスティング、ファイルの保存、コンテンツ配信",
            "Vercel: Web サイトと Web アプリのホスティング",
            "Stripe: 支払いと請求",
            "Resend: サインインと招待のメール",
        ...
        },
        {
          heading: "情報の保存場所",
          paragraphs: [
            "CyberAgent Cloud は Amazon Web Services と Vercel 上でホストされています。当社およびサービス提供者は、米国その他の国や地域でお客様の情報を処理することがあります。どこで処理される場合も、本ポリシーに従って情報を保護します。",
          ],
        },
        {
          heading: "保存期間",
          paragraphs: [
            "アカウント情報とワークスペースのコンテンツは、アカウントやワークスペースが存在する間保存します。ワークスペースのオーナーがワークスペースを削除すると、そのタスクやコメントなどのコンテンツは CyberAgent Cloud から削除されます。ただし、復旧用のバックアップには、削除後もしばらくの間コピーが残ることがあります。削除したワークスペースにアップロードされたファイルをファイルストレージから消去したい場合は、[support@multica.ai](mailto:support@multica.ai) までご連絡ください。請求記録は会計・税務上必要な期間保存し、製品分析データ、クラッシュレポート、営業へのお問い合わせ、フィードバックは、サポートと製品改善に必要な期間保存します。お問い合わせとフィードバックは、ご依頼があれば削除します。",
          ],
        },
        {
          heading: "お客様の選択と権利",
          paragraphs: [
            "お住まいの地域の法令によっては、個人情報へのアクセス、訂正、削除、書き出しを求める権利、特定の処理に異議を唱えたり制限したりする権利、すでに与えた同意(マーケティング情報の受信など)を撤回する権利、そして地域のデータ保護当局に苦情を申し立てる権利がある場合があります。プロフィールは Multica 内でいつでも更新でき、オーナーであるワークスペースは設定から削除できます。アカウントの削除など、そのほかのご依頼は [support@multica.ai](mailto:support@multica.ai) までメールでご連絡ください。30日以内に回答します。",
          ],
        },
        {
          heading: "セキュリティ",
          paragraphs: [
            "通信の暗号化、アクセス制御、連携サービスの認証情報の暗号化保存などにより、お客様の情報を保護しています。完全に安全なシステムは存在しないため、アカウントが不正に利用されたと思われる場合は、すぐにご連絡ください。",
          ],
        },
        {
          heading: "お子様について",
          paragraphs: [
            "Multica は16歳未満のお子様を対象としておらず、当社がお子様の個人情報を故意に収集することはありません。",
          ],
        },
        {
          heading: "ポリシーの変更",
          paragraphs: [
            "本ポリシーは随時更新されることがあります。新しい版はこのページに掲載し、冒頭の日付を更新します。重要な変更がある場合は、効力が生じる前にお知らせします。",
          ],
        },
        {
          heading: "お問い合わせ",
          paragraphs: [
            "Multica は Index Labs (Hong Kong) Limited が運営しており、同社がお客様の個人情報について責任を負います。プライバシーに関するご質問やご依頼は、[support@multica.ai](mailto:support@multica.ai) までメールでご連絡ください。",
          ],
        },
      ],
    },
    ...
    contactSales: {
      ...
      consent: {
        intro:
          "Multica はあなたのプライバシーを尊重します。お預かりした個人情報は、アカウントの管理と、ご依頼いただいた製品・サービスの提供のためにのみ使用します。ときどき、製品アップデートやベストプラクティス、ご参考になりそうなインサイトもお届けできればと思います。ご希望の場合は、下でお知らせください。",
        outreach:
          "サービスのアップデート、サポートへのお問い合わせ、ビジネス関連のフォローアップなど、Multica からの個別のご連絡を受け取ります。",
        updates:
          "Multica からの製品アップデート、インサイト、イベントへのご招待を受け取ります。",
        unsubscribe:
          "配信はいつでも停止できます。データの取り扱いとプライバシーの権利について詳しくは、こちらをご確認ください:",
        submitConsent:
          "「送信」をクリックすると、ご依頼いただいたコンテンツをお届けするために、Multica が情報を保存・処理することに同意したことになります。",
