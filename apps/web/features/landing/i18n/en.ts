...
export function createEnDict(
  ...
  hero: {
    ...
    subheading:
      "CyberAgent is an open-source platform that turns coding agents into real teammates. Assign tasks, track progress, compound skills \u2014 manage your human + agent workforce in one place.",
    cta: "Start free trial",
    downloadDesktop: "Download Desktop",
    talkToSales: "Talk to sales",
    worksWith: "Works with",
    imageAlt: "CyberAgent board view \u2014 issues managed by humans and agents",
  },
    ...
    runtimes: {
      ...
      cards: [
        ...
        },
        {
          ...
          description:
            "CyberAgent scans for 11 supported coding tools \u2014 Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi \u2014 and registers a runtime for each one it finds.",
        },
      ],
    },
  },
    ...
    highlights: [
      {
        ...
        description:
          "Run CyberAgent on your own infrastructure. Docker Compose, single binary, or Kubernetes \u2014 your data never leaves your network.",
      },
      {
  ...
  faq: {
    ...
    items: [
      {
        question: "What coding agents does CyberAgent support?",
        answer:
          "CyberAgent supports 11 coding tools out of the box: Claude Code, Codex, Cursor, Copilot, Gemini, Hermes, Kimi, Kiro CLI, OpenCode, OpenClaw, and Pi. The daemon auto-detects whichever CLIs you already have installed and registers a runtime for each one. Since it's open source, you can also add your own backends.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Coding agents are great at executing. CyberAgent adds the management layer: task queues, team coordination, skill reuse, runtime monitoring, and a unified view of what every agent is doing. Think of it as the project manager for your agents.",
      },
      {
        question: "Can agents work on long-running tasks autonomously?",
        answer:
          "Yes. CyberAgent manages the full task lifecycle \u2014 enqueue, claim, execute, complete or fail. Agents report blockers proactively and stream progress in real time. You can check in whenever you want or let them run overnight.",
      },
      {
        question: "Is my code safe? Where does agent execution happen?",
        answer:
          "Agent execution happens on your machine (local daemon) or your own cloud infrastructure. Code never passes through CyberAgent servers. The platform only coordinates task state and broadcasts events.",
      },
      {
  ...
  footer: {
    ...
    copyright: "\u00a9 {year} CyberAgent. All rights reserved.",
  },
  ...
  changelog: {
    title: "Changelog",
    subtitle: "New updates and improvements to CyberAgent.",
    toc: "All releases",
    categories: {
    ...
    entries: [
      ...
      },
      {
        ...
        changes: [],
        features: [
          "Connect GitHub so linked pull requests appear on CyberAgent issues, sync their status, and close the CyberAgent issue automatically when the PR closes",
        ...
        improvements: [
          ...
          "Linux desktop packages show the CyberAgent app icon again",
        ],
        fixes: [
      ...
      },
      {
        ...
        fixes: [
          ...
          "Windows / Linux desktop replaces the Electron placeholder icon with the CyberAgent asterisk",
      ...
      },
      {
        ...
        improvements: [
          ...
          "CyberAgent Agent commits include a `Co-authored-by` trailer for proper Git attribution",
  ...
  contactSales: {
    ...
    useCases: [
      { value: "evaluate", label: "Evaluating CyberAgent for my team" },
      { value: "adopt_team", label: "Rolling out CyberAgent to a team or company" },
      { value: "self_host", label: "Self-hosting on our own infrastructure" },
      { value: "integrate", label: "Integrating CyberAgent with existing tools" },
    ...
    consent: {
      ...
      outreach:
        "I’d like to receive one-to-one communication from CyberAgent, Inc., including service updates, support inquiries, and business-related follow-ups.",
      updates:
        "I’d like to receive product updates, insights, and event invitations from CyberAgent.",
      unsubscribe:
    ...
    success: {
      ...
      message:
        "A member of the CyberAgent team will respond within three business days. In the meantime, feel free to explore the docs or star us on GitHub.",
      cta: "Back to home",
    },
    errors: {
