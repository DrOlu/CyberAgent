...
function AppContent() {
  ...
  // Listen for invite IDs delivered via deep link (cyberagent://invite/<id>).
  ...
  // Listen for auth token delivered via deep link (cyberagent://auth/callback?token=...).
    ...
    <div className="flex h-screen items-center justify-center bg-background p-8 text-foreground">
      <div className="max-w-xl rounded-lg border bg-card p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm text-muted-foreground">
          CyberAgent Desktop could not load <code>~/.multica/desktop.json</code>. Fix or remove the file and restart the app.
        </p>
