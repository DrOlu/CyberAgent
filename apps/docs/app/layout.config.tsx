...
// Docs-local stateless CyberAgent mark — matches @multica/ui's CyberAgentIcon
...
// desktop). Leading icon = brand identity (GitHub mark / CyberAgent asterisk);
...
export const baseOptions: BaseLayoutProps = {
  nav: {
    title: (
      <span className="font-semibold text-base">CyberAgent Docs</span>
    ),
  },
  links: [
    {
    ...
    {
      icon: <CyberAgentMark />,
      text: externalLinkText("CyberAgent"),
