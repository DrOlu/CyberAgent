---
title: 故障排查
description: self-host CyberAgent 遇到的 Top 7 常见问题——症状、原因、怎么查、怎么修。
---

import { Callout } from "fumadocs-ui/components/callout";

按症状查问题。每条问题都给**症状 / 可能原因 / 怎么查 / 怎么修**四段。如果你的情况不在下面，到 [GitHub](https://github.com/DrOlu/CyberAgent/issues) 提 issue。
