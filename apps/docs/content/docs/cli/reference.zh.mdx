---
title: CLI Reference
description: Complete command reference for the CyberAgent CLI and agent daemon.
---
...
When connecting to a self-hosted CyberAgent instance, point the CLI to your server before logging in:
