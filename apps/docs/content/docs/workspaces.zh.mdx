...
工作区（workspace）是 CyberAgent 里**一群人一起协作的独立空间**——所有 [issue](/issues)、[成员](/members-roles)、[评论](/comments)、[智能体](/agents) 都属于它。你登录进来看到的任务列表、成员名单、智能体配置都限定在当前工作区；**切换工作区，看到的内容会完全替换**。
