---
title: Contribuer
description: Configurez un environnement de développement CyberAgent local, exécutez les tests et soumettez vos modifications en suivant les conventions du dépôt.
---

import { Callout } from "fumadocs-ui/components/callout";

CyberAgent est composé d'un backend Go et d'un monorepo pnpm. Le moyen le plus simple de démarrer en local est `make dev` : cette commande prépare l'environnement, la base de données et les migrations pour le checkout courant, puis démarre Web et l'API.
