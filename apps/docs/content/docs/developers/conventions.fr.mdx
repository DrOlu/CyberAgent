...
Si vous écrivez du code CyberAgent, modifiez une traduction ou rédigez des textes produit en chinois, c'est la page de référence.
...
### La distinction essentielle : nom courant vs terme propre à CyberAgent

Les noms de produit de CyberAgent se répartissent en deux catégories :
...
- **Terme propre à CyberAgent** — un concept qu'aucun mot local ne porte (`skill`), ou un identifiant de niveau schéma qu'un utilisateur peut avoir à saisir ou à faire correspondre (`todo`, `in_progress`, `task_id`). Écrivez-le en **anglais minuscule** pour qu'il se lise comme un nom de type.
...
- **`skill`** reste en anglais minuscule dans le texte chinois — c'est un concept propre à CyberAgent sans terme chinois établi ; les titres peuvent l'écrire avec une majuscule, `Skills`.
...
| Catégorie | Termes |
| --- | --- |
| Marques | **CyberAgent**, GitHub, Slack, Google, Anthropic, OpenAI, Claude, Codex, Cursor, Linear, Jira |
