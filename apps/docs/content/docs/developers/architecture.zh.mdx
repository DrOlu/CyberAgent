---
title: Architecture
description: Technical architecture of the CyberAgent platform.
---

## Overview

CyberAgent is a Go backend + monorepo frontend (pnpm workspaces + Turborepo) with shared packages.
