...
```
Fetch https://github.com/multica-ai/multica/blob/main/CLI_INSTALL.md and follow the instructions to install CyberAgent CLI, log in, and start the daemon on this machine.
```
