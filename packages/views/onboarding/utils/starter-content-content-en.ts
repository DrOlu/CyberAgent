  ...
  switch (q.use_case) {
    case "ship_code":
      return {
        ...
        description: `${header}Hi agent, this is ${name}'s first time using CyberAgent. They plan to use you mostly for **shipping code**.\n\n${sharedInstructions}`,
      };
    case "manage_team":
    case "plan_research":
      return {
    ...
    case "write_publish":
      return {
        title: "👋 Welcome to CyberAgent — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using CyberAgent. They'll use you for **writing and publishing** — drafting, editing, summarizing.\n\n${sharedInstructions}`,
      };
    case "evaluate":
      return {
        title: "👋 Welcome to CyberAgent — let's work together",
    ...
    case "automate_ops":
      return {
        title: "👋 Welcome to CyberAgent — let's work together",
        description: `${header}Hi agent, this is ${name}'s first time using CyberAgent. They want your help with **day-to-day tasks and automation**.\n\n${sharedInstructions}`,
      };
    case "other": {
