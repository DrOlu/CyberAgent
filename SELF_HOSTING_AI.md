...
This document is designed for AI agents to execute. Follow these steps exactly to deploy a local CyberAgent instance and connect to it.
...
Wait for the server output `✓ CyberAgent server is running and CLI is ready!` before running `multica setup self-host`.
