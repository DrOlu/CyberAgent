...
func TestGeminiStaticModelsExposesAliasesAndGemini3(t *testing.T) {
	...
	// for cyberagent.sh/multica#1503 — Gemini 3 must be selectable.
...
func TestCodexStaticModelsExposesGPT55(t *testing.T) {
	...
	// hand-maintained. Regression guard for cyberagent.sh/multica#2009 —
...
func TestCopilotStaticModelsExposesFullCatalog(t *testing.T) {
	...
	// docs. Regression guard for cyberagent.sh/multica#1948 — the
