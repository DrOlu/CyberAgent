...
type CloudFrontSigner struct {
	...
	domain       string // CDN domain, e.g. "static.cyberagent.sh"
	cookieDomain string // cookie scope, e.g. ".cyberagent.sh"
}
...
//   - CLOUDFRONT_DOMAIN       (e.g. "static.cyberagent.sh")
//   - COOKIE_DOMAIN           (e.g. ".cyberagent.sh")
