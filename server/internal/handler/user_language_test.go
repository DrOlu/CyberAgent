...
func TestUpdateMeAcceptsLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-set@cyberagent.sh")
...
func TestUpdateMeRejectsUnsupportedLanguage(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-reject@cyberagent.sh")
...
func TestUpdateMePreservesLanguageWhenNotProvided(t *testing.T) {
	userID := newLanguageTestUser(t, "lang-preserve@cyberagent.sh")
